...
def main():
    if len(sys.argv) < 2:
        ...
        print("="*60)
        print("\nUsage: python detector.py <pdf_file> [options]")
        print("\nExamples:")
        print("  python detector.py document.pdf")
        print("  python detector.py document.pdf --detect-only")
        print("  python detector.py document.pdf --skip-white")
        print("  python detector.py document.pdf 400 0.15")
        print("  python detector.py document.pdf 400 0.15 --debug")
        print("  python detector.py document.pdf --extract-corners 377,379")
